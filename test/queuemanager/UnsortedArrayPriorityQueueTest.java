...
public class UnsortedArrayPriorityQueueTest {
    ...
    public final static UnsortedArrayPriorityQueue<String> instance = new UnsortedArrayPriorityQueue<>(100);
    ...
    public void testToString() {
        ...
        */
        expResult = "[("+nameInput3+", "+priorityInput3+"), ("+nameInput2+", "+priorityInput2+"), ("+nameInput+", "+priorityInput+")]"; 
